...
mvn dependency:copy -Dartifact=com.stratio.jdbc:stratio-crossdata-jdbc4:2.16.2-2e12375 -DoutputDirectory=./bin/lib/
mvn install:install-file -Dfile=./bin/lib/stratio-crossdata-jdbc4-2.16.2-2e12375.jar -DgroupId=com.stratio.jdbc -DartifactId=stratio-crossdata-jdbc4 -Dversion=2.16.2-2e12375 -Dpackaging=jar
