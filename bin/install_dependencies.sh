...
mvn dependency:copy -Dartifact=com.stratio.jdbc:stratio-crossdata-jdbc4:2.12.2 -DoutputDirectory=./bin/lib/
mvn install:install-file -Dfile=./bin/lib/stratio-crossdata-jdbc4-2.12.2.jar -DgroupId=com.stratio.jdbc -DartifactId=stratio-crossdata-jdbc4 -Dversion=2.12.2 -Dpackaging=jar
