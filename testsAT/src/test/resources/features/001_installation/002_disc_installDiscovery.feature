...
Feature: Install Discovery for Discovery
  ...
  @runOnEnv(DISC_VERSION=0.29.0-d524010||DISC_VERSION=0.30.0-SNAPSHOT)
  Scenario: [Basic Installation Discovery][01] Obtain postgreSQL ip and port
  ...
  @runOnEnv(DISC_VERSION=0.28.9||DISC_VERSION=0.29.0-d524010||DISC_VERSION=0.30.0-SNAPSHOT)
